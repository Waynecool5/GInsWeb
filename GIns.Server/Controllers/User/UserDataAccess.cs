...
namespace GIns.Server.Controllers.User
    ...
    {
        public ICollection<Users> oUsers { get; set; }
        ...
        public async Task<IEnumerable<Users>> GetUsersAsync(int apiType)
        {
            ...
            using (var Sqlconn = new SqlConnection(conn))
            {
                ...
                Parm parm = new Parm { DocumentID = -1, Mode = apiType, User_id = 0 };
                //Execute Storeprocedure for all Points

                oUsers = Sqlconn.Query<Users>("UserData", parm); //Parameters.Empty);//,
        ...
        public async Task<IEnumerable<Users>> GetAll()
        {
            ...
            using (var Sqlconn = new SqlConnection(conn))
            {
                ...
                Parm parm = new Parm { DocumentID = -1,  User_id = 0 };
                //Execute Storeprocedure for all Points
